...
export class WorldInteractionFactory {
  ...
  create(): any {
    ...
    const entityIntersectHelper = new EntityIntersectHelper(
      map,
    ...
    const unitSelectionHandler = new UnitSelectionHandler(
      this.worldScene,
      this.uiScene,
      this.localPlayer,
      this.unitSelection,
    ...
    const defaultActionHandler = DefaultActionHandler.factory(
      this.renderableManager,
      this.unitSelection,
    ...
    const mapHoverHandler = new MapHoverHandler(
      entityIntersectHelper,
      mapTileIntersectHelper,
      map,
      shroud,
    ...
    const mapScrollHandler = new MapScrollHandler(
      renderer.getCanvas(),
      worldScene.cameraPan,
      pointer,
    ...
    const minimapHandler = new MinimapHandler(
      this.minimap,
      map,
      shroud,
      worldScene,
    ...
    const targetLines = new TargetLines(
      this.localPlayer,
      this.unitSelection,
      worldScene.camera,
      this.debugPaths,
