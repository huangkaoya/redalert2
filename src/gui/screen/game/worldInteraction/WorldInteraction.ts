...
export class WorldInteraction {
  ...
  constructor(
    ...
    private readonly pointerEvents: any,
    private readonly cameraPanHandler: any,
    private readonly mapScrollHandler: any,
    private readonly mapHoverHandler: any,
    private readonly tooltipHandler: any,
    public readonly entityIntersectHelper: any,
    public readonly unitSelectionHandler: any,
    public readonly defaultActionHandler: any,
    public readonly keyboardHandler: any,
    public readonly arrowScrollHandler: any,
    public readonly customScrollHandler: any,
    public readonly minimapHandler: any,
    private readonly cameraZoom: any,
    private readonly document: Document,
    private readonly renderer: any,
    public readonly targetLines: any,
    private readonly rightClickMove: any,
    private readonly rightClickScroll: any,
    private readonly battleControlApi: any,
  ) {}
  ...
  private readonly handleFrame = (time: number): void => {
    ...
    if (
      (this.lastDefaultActionUpdate === undefined || time - this.lastDefaultActionUpdate >= 1000 / 15) &&
      !this.currentMode &&
      !this.mapScrollHandler.isScrolling() &&
  ...
  private handleDefaultClickAction(
    rightClickMove: boolean,
    executeDefaultClick: boolean,
    allowTypeSelect: boolean,
    touchForceAttack: boolean,
    event: any,
    hover: any,
  ): void {
    if (!hover) {
    ...
    this.defaultActionHandler.execute(
      ...
      allowTypeSelect,
      touchForceAttack ? { ...event, ctrlKey: true } : event,
    );
  }
  ...
  private isClickRange(pointer: { x: number; y: number }): boolean {
