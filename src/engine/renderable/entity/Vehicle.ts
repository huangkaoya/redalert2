...
export class Vehicle {
    ...
    updateBaseLight() {
        (this.baseShpExtraLight = this.lighting
            ...
            (this.baseVxlExtraLight = new THREE.Vector3().addScalar(this.lighting.computeNoAmbient(this.objectArt.lightingType, this.gameObject.tile, this.gameObject.tileElevation) + this.rules.audioVisual.extraUnitLight));
    }
    registerPlugin(e) {
        this.plugins.push(e);
    }
